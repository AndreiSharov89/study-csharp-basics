...
namespace FirstClass
{
    public class TriCompare
    {
        static void Main()
        {
            ...
            string typeCheck;
            Triangle new1, new2;
            Console.WriteLine("First triangle has equal sides? y/n");
            ...
            Console.WriteLine("Second triangle has equal sides? y/n");
            typeCheck = Console.ReadLine();
            if (typeCheck == "y")
            {
                Console.WriteLine("Enter triangle side:");
                new2 = new Triangle(double.Parse(Console.ReadLine()));
            }
            else
            {
                Console.WriteLine("Enter side A:");
